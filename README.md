...
# Grafana SDK [![Go Report Card](https://goreportcard.com/badge/github.com/galamiram/sdk)](https://goreportcard.com/report/github.com/galamiram/sdk)
...
[autograf](https://github.com/galamiram/autograf) project but
...
## Examples [![GoDoc](https://godoc.org/github.com/galamiram/sdk?status.svg)](https://godoc.org/github.com/galamiram/sdk)
...
## Installation [![Build Status](https://travis-ci.org/galamiram/sdk.svg?branch=master)](https://travis-ci.org/galamiram/sdk)

Of course Go development environment should be set up first. Then:

	go get github.com/galamiram/sdk
...
## Status of REST API realization [![Coverage Status](https://coveralls.io/repos/github/galamiram/sdk/badge.svg?branch=master)](https://coveralls.io/github/galamiram/sdk?branch=master)
...
https://github.com/galamiram/sdk
